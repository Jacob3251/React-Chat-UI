      ...
      <div className="flex justify-center items-center h-full">
        <div className="bg-hov rounded-lg p-10 text-tColor">
          <div className="flex items-center justify-center space-x-5">
            ...
            <input
              className="bg-hov outline-none border-secondary py-2 border-b-[2px]"
              type="text"
              name="grpName"
          ...
          {/* description */}
          <div className="bg-[#ff0000] w-full mt-5">
            <input
              className="w-full bg-hov placeholder:text-[14px] border-b-[2px] border-secondary pb-1 focus:border-notification outline-none"
          ...
          {showSearchList && (
            <div className="flex justify-end space-x-1">
              <button
                onClick={() => setShowSearchList(!showSearchList)}
                className="rounded-md bg-secondary duration-300 hover:bg-[#C70039] font-semibold text-tColor hover:drop-shadow-md px-2 py-2"
              >
                Cancel
              </button>
              <button
