  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="text-tColor flex justify-between bg-secondary py-2 px-5">
        <h1 className="text-[22px] font-semibold">Saved Messages</h1>
        {/* button options */}
      ...
      <div className="bg-secondary text-tColor flex justify-between space-x-2 py-3 px-5">
        <div className="flex space-x-2  w-full">
          ...
          <div className="w-full">
            ...
            <input
              ...
              className="w-full bg-secondary placeholder:text-[18px] text-[18px]"
            />
          </div>
        </div>
